...
private:
  ...
  ConditionScope* pConditionScope;
	PushCondition* pPushCondition;
	ClassDefinition* pClassDefinition;
	EndOfClass* pEndofClass;
	PushClass* pPushClass;
	NSDefinition* pNSDefinition;
	PushNS* pPushNS;
	ControlScope* pControlScope;
	PushControl* pPushControl;
	ArrayDefinition* pArrayDefinition;
	PushArray* pPushArray;
